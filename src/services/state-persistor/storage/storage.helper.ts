...
class StorageHelper {
  mapToEntity<T>(value: string | null, mapper?: (value: string | null) => T | T[]) {
    return mapper ? mapper(value) : value
  }

  mapToStorage<T>(value: T, mapper?: (value: T) => string): string
  mapToStorage<T>(value: T[], mapper?: (value: T[]) => string): string
  mapToStorage<T>(value: T | T[] | null, mapper?: (value: T | T[] | null) => string): string {
  ...
  setValue<T>(key: string, value: T, mapper?: (value: T | undefined) => string): void
  setValue<T>(key: string, value: T, mapper?: (value: T | null) => string): void
  setValue<T>(key: string, value: T[], mapper?: (value: T[] | null) => string): void
  setValue<T>(key: string, value: T | T[], mapper?: (value: T | T[] | null) => string) {
